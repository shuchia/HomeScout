...
export default function UpgradePrompt({ feature, inline = false, className = '' }: UpgradePromptProps) {
  ...
  return (
    <div className={`bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg p-6 text-center ${className}`}>
      ...
      <Link
        href="/pricing"
        className="inline-block bg-[var(--color-primary)] text-white px-6 py-2 rounded-lg hover:bg-[var(--color-primary-light)] transition-colors font-medium"
      >
